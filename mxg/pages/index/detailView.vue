			...
			<view class="thr-tab" v-show="currentId==2">
				<view class="thr-tab-item" v-for="item in commentList" :key="item.id">
					<view class="top">
						...
						<image class="flower" v-if="!item.isGood" src="../../static/images/flower.png" mode="">
						</image>
						<image class="flower" v-else src="../../static/images/grayflower.png" mode=""></image>
					</view>
					<view class="content">
						{{ item.content }}
					</view>
